...
module TopModule_tb;
    ...
    initial begin
        $display("Time\tPC\tOpcode\tA\tB\tAddr\tALU_Out\tMem_Out");
        clk = 0;
        reset = 1; #10;
        reset = 0;
